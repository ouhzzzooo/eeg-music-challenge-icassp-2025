...
def parse():
    ...
    parser.add_argument('--scheduler_metric', type=str, default='loss', choices=['loss', 'accuracy', 'balanced_accuracy'], help='Metric to monitor for LR scheduler')
    parser.add_argument('--scheduler_mode', type=str, default='min', choices=['min', 'max'], help='Mode for LR scheduler metric')
    parser.add_argument('--early_stopping_metric', type=str, default='loss', choices=['loss', 'accuracy', 'balanced_accuracy'], help='Metric to monitor for early stopping')
    parser.add_argument('--early_stopping_mode', type=str, default='min', choices=['min', 'max'], help='Mode for early stopping metric')
    parser.add_argument('--es_patience', type=int, default=10, help='Patience for early stopping')
